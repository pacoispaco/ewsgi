...
feature -- Status codes
    ...
    status_codes: HASH_TABLE [STRING, STRING] is
            -- Enables writing of 'status_code := status_codes @ "No Content"'.
        once
	        ...
	        Result ["Multiple Choices"] = "300"
	        Result ["Moved Permanently"] = "301"
	        Result ["Found"] = "302"
	        Result ["See Other"] = "303"
	        Result ["Not Modified"] = "304"
	        Result ["Use Proxy"] = "305"
	        Result ["Temporary Redirect"] = "307"
        end

    status_reasons: HASH_TABLE [STRING, STRING] is
            -- Enables writing of 'status_reason := status_reasons @ "200"' and
            -- 'status_reason := status_reasons @ Ok'
        once
            Create Result.make (25)
            Result ["100"] = "Continue"
